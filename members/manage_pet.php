  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
		...
		<select name="status">
		 <option value="<?php echo $status; ?>"><?php if($status == "1"){echo "Safe";}else{echo "Missing";} ?></option>
			<option value="<?php if($status == "2"){echo "1";}else{echo "2";} ?>"><?php if($status == "2"){echo "Safe";}else{echo "Missing";} ?></option>
		  </select>
