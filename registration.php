    ...
    <tr>
      ...
      <td width="268">
		<?php
		  ...
		  if($_SESSION['firstnameerror'] != ""){echo $_SESSION['firstnameerror'];
  ...
  <tbody>
    <tr>
      ...
      <td width="38%"><input name="firstname" type="text" value="<?php
		  ...
		  if($_SESSION['firstname'] != ""){echo $_SESSION['firstname'];}?>" size="24" maxlength="24"></td>
      <td>&nbsp;</td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		  ...
		  if($_SESSION['lastnameerror'] != ""){echo $_SESSION['lastnameerror'];
    ...
    <tr>
      ...
      <td><input name="lastname" type="text" value="<?php
		  ...
		  if($_SESSION['lastname'] != ""){echo $_SESSION['lastname'];}?>" size="24" maxlength="24"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="emailaddress" type="text" value="<?php
		  ...
		  if($_SESSION['email_address'] != ""){echo $_SESSION['email_address'];}?>" size="24" maxlength="32"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		  ...
		  if($_SESSION['cityerror'] != ""){echo $_SESSION['cityerror'];
    ...
    <tr>
      ...
      <td><input name="city" type="text" size="24" maxlength="32" value="<?php
		  ...
		  if($_SESSION['city'] != ''){echo $_SESSION['city'];}?>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		  ...
		  if($_SESSION['stateerror'] != ""){echo $_SESSION['stateerror'];
											
											//Unsetting blank state error message
											unset($_SESSION['stateerror']);} ?></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		  ...
		  if($_SESSION['ziperror'] != ""){echo $_SESSION['ziperror'];
    ...
    <tr>
      ...
      <td><input name="zip" type="text" value="<?php
		  ...
		  if($_SESSION['zip'] != ""){echo $_SESSION['zip'];}?>" size="5" maxlength="5"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		...
		if($_SESSION['mobilenumbererror'] != ""){echo $_SESSION['mobilenumbererror'];
		  ...
		  if($_SESSION['numberinuse'] != ""){echo $_SESSION['numberinuse'];
    ...
    <tr>
      ...
      <td><input name="mobilenumber" type="tel" value="<?php
		  ...
		  if($_SESSION['mobilenumber'] != ''){echo $_SESSION['mobilenumber'];} ?>" size="10" maxlength="10"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php
		  ...
		  //Displaying error message if confirmation password field is empty
		   if($_SESSION['passwordtwo'] != ""){echo $_SESSION['passwordtwo'];
		  		   ...
		  		   if($_SESSION['passwordmatch'] != ""){echo $_SESSION['passwordmatch'];
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td colspan="2"><input type="password"  name="confirmpassword" size="24" maxlength="18" value="<?php if($_SESSION['password'] != ""){echo $_SESSION['password'];}?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="2"><input type="hidden" name="reg" value="reg"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
