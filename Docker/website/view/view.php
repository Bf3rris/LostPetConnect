...
//Setting pet id var
if(isset($_REQUEST['petid'])){$petid = strip_tags($_REQUEST['petid']);}
...
$calllog = "INSERT INTO call_log (date, request_time, uid, out_id, from_number, code, call_id, pid, request_ip, ics, icamd, notes, tag, active_call) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($calllog);
$stmt->bind_param('ssssssssssssss', $date, $time, $uid, $blank, $blank, $code, $blank, $petid, $_SERVER['REMOTE_ADDR'], $blank, $blank, $blank, $blank, $blank);
$stmt->execute();
$stmt->close();
}
...
?>
                        ...
                        <table width="200" border="0" cellspacing="0" cellpadding="0">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td colspan="2" rowspan="4" align="center"><a href="sms:+<?php echo $xfn; ?>?body=Your+pet+has+been+found:<?php echo $petid;?>"><img src="../images/text.png"></a></td>
                              </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="view.php?petid=<?php echo $petid . '&gencode=true';?>">Generate code</a></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
